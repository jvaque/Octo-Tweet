CREATE TABLE IF NOT EXISTS octo_tweet.Electricity (
    ...
    UNIQUE KEY UC_electricity_interval_start (electricity_interval_start_datetime, electricity_interval_start_offset),
    UNIQUE KEY UC_electricity_interval_end (electricity_interval_end_datetime, electricity_interval_end_offset)
) AUTO_INCREMENT = 1000;
